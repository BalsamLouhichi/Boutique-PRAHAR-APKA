...
INSERT INTO categories (name, designation, description) VALUES
    ...
    ('Écharpes', 'echarpes', 'Écharpes toutes saisons', 4);
...
('CAS-002', 'Casquette Snapback Urbaine', 'casquette-snapback-urbaine', 'Casquette snapback style urbain, visière plate.', 1, 'toutes_saisons', 'homme', 12, ARRAY['Noir','Gris'], ARRAY['Taille unique'], 'Polyester', TRUE, FALSE),
...
('ECH-001', 'Écharpe Rayée Automne', 'echarpe-rayee-automne', 'Écharpe rayée légère, idéale mi-saison.', 4, 'automne', 'femme', 15, ARRAY['Beige/Marron','Gris/Noir'], ARRAY['Taille unique'], 'Coton', FALSE, FALSE);
